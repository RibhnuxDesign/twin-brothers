	...
	<div id="content-wrapper" class="contentWrapper" tabindex="-1">
		<main id="main" class="siteMain">
			<header id="page-header" class="pageHeader-author">
				<h1><?php esc_html_e( 'About:', 'twin-brothers' ); ?><?php echo esc_html( $author_nickname ); ?></h1>
				...
				<dl>
					<?php if ( ! empty( $author_url ) ) : ?>
						<dt><?php esc_html_e( 'Website', 'twin-brothers' ); ?></dt>
						<dd>
					...
					<?php if ( ! empty( $author_desc ) ) : ?>
						<dt><?php esc_html_e( 'Profile', 'twin-brothers' ); ?></dt>
						<dd><?php echo esc_html( $author_desc ); ?></dd>
					<?php endif; ?>
				</dl>

				<h2><?php esc_html_e( 'Posts by', 'twin-brothers' ); ?> <?php echo esc_html( $author_nickname ); ?>
					:</h2>
			</header><!-- #page-header -->
			...
			if ( have_posts() ) :
				...
				?>
					<li>
						...
						<?php esc_html_e( 'in', 'twin-brothers' ); ?> <?php the_category( '&' ); ?>
					</li>
				<?php
				endwhile;
				echo '</ul>';
